...
public class UserServiceActivity extends BaseActivity {
    String text = "您好！欢迎您使用" + MyApplication.mApplicationContext.getResources().getString(R.string.app_name) + "。\n" +
            "\n" +
            "1.特别提示\n" +
            "\n" +
            ...
            "2.服务内容\n" +
            "\n" +
            "2.1" + MyApplication.getInstance().getResources().getString(R.string.app_name) + "APP平台内严禁一切非法、涉黄信息，违反社区运营规范者，一律封号处理。\n" +
            "\n" +
